...
widget_style!{
    KIND;
    /// Represents the unique styling for our ColorPicker widget.
    style Style {
        /// Color of the button.
...
impl<'a, F> ColorPicker<'a, F> {
    /// Create a button context to be built upon.
    pub fn new() -> ColorPicker<'a, F> {
        ColorPicker {
...
impl<'a, F> Widget for ColorPicker<'a, F>
    where F: FnMut()
{
...
impl<'a, F> Colorable for ColorPicker<'a, F> {
...
impl<'a, F> Labelable<'a> for ColorPicker<'a, F> {
